...
**Spirit Character**: Darlene Anderson from Mr. Robot *(the smart, sarcastic, no-nonsense hacker vibes)*
...
### 🚁 [NimbusTrace](https://github.com/JnHarmad/NimbusTrace)
**Standardized GCS with AI Integration**
...
- **Tech Stack**: Python, Digital Forensics
- **Description**: Advanced IoT device forensic investigation and analysis framework with data extraction capabilities
- **Focus**: Digital forensics, IoT security, forensic data extraction, evidence preservation
